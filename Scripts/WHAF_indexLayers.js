...
healthScoreIndex = {
    ...
    "Bio Index - Animal Species Richness (major)" : 25,
    "Bio Index - At Risk Species Richness (major)" : 26,
    "Con - Mean Score (major)" : 27,
    "Con - Minnimum Score (major)" : 28,
    "Con Index - Terrestrial Habitat Connectivity (major)" : 29,
    "Con Index - Aquatic Connectivity (major)" : 30,
    "Con Index - Riparian Connectivity (major)" : 31,
    "WQ - Mean Score (major)" : 32,
    "WQ - Minnimum Score (major)" : 33,
    "WQ Index - Non-Point Source (major)" : 34,
    "WQ Metric - Non-Point Source, Phosphorus Risk (major)" : 35,
    "WQ Index - Localized Pollution Sources (major)" : 36,
    "WQ Index - Water Quality Assessments (major)" : 37,
    "Hyd Index - Perennial Cover, 2011" : 39,
    "Hyd Index - Perennial Cover, 2006" : 40,
    "Hyd Index - Perennial Cover, 2001" : 41,
    "Hyd Index - Impervious Cover, 2011" : 42,
    "Hyd Index - Impervious Cover, 2006" : 43,
    "Hyd Index - Impervious Cover, 2001" : 44,
    "Hyd Index - Water Withdrawal" : 45,
    "Hyd Index - Water Withdrawal, Predicted Vulnerability" : 46,
    "Hyd Index - Loss of Hydrologic Storage" : 47,
    "Hyd Metric - Loss of Hydrologic Storage, Wetland Loss" : 48,
    "Hyd Metric - Loss of Hydrologic Storage, Altered Watercourse" : 49,
    "Geo Index - Soil Erosion Potential" : 50,
    "Bio Index - Terrestrial Habitat Quality" : 51,
    "Bio Metric - Mussel Score Extrapolated Hightlight" : 52,
    "Bio Metric - Mussel Score Extrapolated" : [52, 53, 54],
    "Bio Metric - Mussel Score" : 54,
    "Bio Metric - Stream Species Quality, Aquatic Invertebrate IBI Extrapolated Highlight" : 55,
    "Bio Metric - Stream Species Quality, Aquatic Invertebrate IBI Extrapolated" : [55, 56, 57],
    "Bio Metric - Stream Species Quality, Aquatic Invertebrate IBI" : 57,
    "Bio Metric - Stream Species Quality, Fish IBI Extrapolated Highlight" : 58,
    "Bio Metric - Stream Species Quality, Fish IBI Extrapolated" : [58, 59, 60],
    "Bio Metric - Stream Species Quality, Fish IBI" : 60,
    "Con Index - Aquatic Connectivity" : 61,
    "Con Index - Riparian Connectivity" : 62,
    "WQ Index - Localized Pollution Sources" : 63,
    "WQ Metric - Localized Pollution Sources, Animal Units" : 64,
    "WQ Metric - Localized Pollution Sources, Potential Contaminants" : 65,
    "WQ Metric - Localized Pollution Sources, Septic Systems" : 66,
    "WQ Metric - Localized Pollution Sources, Wastewater Treatment Plants" : 67,
...
indexdescNewJson={
    ...
    "H_S_HS": {
        ...
        "shortDesc": "<h4>Hydrologic Storage</h4>Hydrologic storage refers to  places on the landscape that provide either temporary or permanent water storage.  Examples include lakes, rivers, permanent or seasonal wetlands, and floodplains.  The Hydrologic Storage Index compares water storage features in the 1890s to surface area available to store water today; and the ratio of natural stream length to channelized stream length for each watershed.  For more details, click <a href='http://www.dnr.state.mn.us/whaf/about/scores/hydrology/storage.html' target='_blank'>here.</a>",
        "sourceData": "",
        "sourceDataDate": "",
