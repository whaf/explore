...
indexdescNewJson={
    ...
    "H_S_HS": {
        ...
        "watershedId": "8",
        "catchmentId": "",
        "indexSummary": "Loss of water storage features, and percent of altered streams",
    ...
    "B_S_SSQ": {
        ...
        "metrics": [{
            ...
            "shortDesc": "<h4>Mussel Quality Metric</h4>This metric is based on the results of the MN DNR statewide survey of mussels in Minnesotaâ€™s major streams and rivers.  Each survey site has a site quality score that combines four underlying population measurements. These four measurements are scored on a 0-100 scale: count of live mussels per minute spent searching, recruitment (presence of juvenile mussels), percent sensitive mussel species, and percent of species present found live.  These four metrics are averaged together to create a mussel site quality score.  <br><br> Mussel catchment scores represent an average of the mussel site quality scores within that catchment. Mussel catchment scores were also extrapolated for catchments directly upstream or downstream from a catchment that has mussel survey sites. In those cases, scores from upstream and downstream catchments were averaged to provide extrapolated scores. Catchments with extrapolated scores are highlighted in the map when zooming in. For more details, click <a href='http://www.dnr.state.mn.us/whaf/about/scores/biology/streamspc.html' target='_blank'>here.</a>",
            "sourceData": "",
            "sourceDataDate": "",
            "caveats": "",
            "longDescLink": "",
