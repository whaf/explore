...
define("esri/dijit/Print", "dojo/_base/declare dojo/_base/lang dojo/_base/connect dojo/_base/array dojo/has dojo/dom dojo/dom-class dojo/dom-construct dijit/Menu dijit/MenuItem dijit/form/Button dijit/form/ComboButton ../tasks/PrintTask ../tasks/PrintParameters ../kernel ../domUtils ../Evented dojo/i18n!../nls/jsapi".split(" "), function(f, d, l, m, n, p, g, h, q, r, s, t, u, v, w, k, x, y) {
    f = f([x], {
        ...
        constructor: function(a, b) {
            ...
            this.printDomNode = h.create("div");
            g.add(this.printDomNode,
                "esriPrint");
            b = p.byId(b);
        ...
        destroy: function() {
            this.map = null;
            h.destroy(this.printDomNode)
        },
        hide: function() {
            k.hide(this.printDomNode)
        },
        show: function() {
            k.show(this.printDomNode)
        },
        printMap: function(a) {
            this.onPrintStart();
            ...
            c.execute(e, d.hitch(this, this._printComplete), d.hitch(this, this._printError))
        },
        _createPrintButton: function() {
            var a = this.templates;
            if (1 === a.length) this._printButton = new s({
                label: this._printText,
            ...
            g.add(this._printButton.domNode, "esriPrintButton")
        },
        _printComplete: function(a) {
            ...
            b.toLowerCase() === c.toLowerCase() ? (window.open(a.url), this._removeAllChildren(this.printDomNode), this._createPrintButton()) : (this._printButton.domNode.style.display = "none", a = h.create("a", {
                href: a.url,
                target: "_blank",
                innerHTML: this._printoutText
            }), l.connect(a, "onclick", d.hitch(this, this._hyperlinkClick)), this._removeAllChildren(this.printDomNode), g.add(a, "esriPrintout"), this.printDomNode.appendChild(a))
        },
    ...
    n("extend-esri") && d.setObject("dijit.Print", f, w);
    return f
});