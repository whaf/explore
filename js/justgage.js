...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    gaugeWidthScale: kvLookup('gaugeWidthScale', config, dataset, 3.0),

    // gaugeColor : string
    // background color of gauge element
    gaugeColor: kvLookup('gaugeColor', config, dataset, "#444444"),
    ...
    labelFontColor: kvLookup('labelFontColor', config, dataset, "#999999"),
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#E60000", "#F1EB00", "#308F00"], 'array', ','),
    ...
    hideMinMax: kvLookup('hideMinMax', config, dataset, true),
  ...
  if (obj.config.counter === true) {
    ...
    eveI.on("raphael.anim.frame." + (obj.level.id), function() {
    ...
    //on animation end
    eveI.on("raphael.anim.finish." + (obj.level.id), function() {
      obj.txtValue.attr({
    ...
    //on animation start
    eveI.on("raphael.anim.start." + (obj.level.id), function() {
      obj.txtValue.attr({
        "text": obj.originalValue
      });
      setDy(obj.txtValue, obj.params.valueFontSize, obj.params.valueY);
