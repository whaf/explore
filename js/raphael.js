...
pieChart = function (cx, cy, r, labels, stroke,colors, scores) {
    var paper = this,
        rad = Math.PI / 180,
        chart = this.set();
    ...
    var angle = 0,
        ...
        process = function (j) {
            var score = scores[j]/100,
                ...
                txt = paper.text(350, 450, labels[j]).attr({fill: bcolor, stroke: "none", opacity: 0, "font-size": 12});
                ...
                p.stop().animate({transform: transformer + cx + " " + cy}, ms);
